-- 🔧 Script de vérification et correction pour Música da Segunda
...
AND table_name IN ('songs', 'albums', 'settings');
...
-- ===== 2. NETTOYER LES ÉLÉMENTS EXISTANTS =====
...
-- ===== 5. CRÉER LA FONCTION ET LES TRIGGERS =====
...
-- ===== 7. CONFIGURER RLS ET POLITIQUES =====
-- Activer RLS
