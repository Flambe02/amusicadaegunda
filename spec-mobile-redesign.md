...
- **Repli :** si PLAYING n'arrive pas en 3 s (mode économie d'énergie, économie de données), la miniature reste, avec la pastille « Toque para ativar o som » et le haut-parleur barré (voir ci-dessous). Jamais d'écran vide.
...
- **Son coupé (décision du 2026-09-25, remplace le gros bouton jaune « Toque para ouvir ») :** une petite pastille discrète en haut de la vidéo, sous le ruban de la semaine — haut-parleur barré + « Toque para ativar o som », fond sombre translucide, texte blanc, pas de jaune —, visible ≈ 3 s à l'arrivée puis fondu de sortie ; elle réapparaît quand le son est refusé après un geste (iOS, économie d'énergie). Tant que le son est coupé, un haut-parleur barré reste en haut à droite (emplacement de Som) ; son actif, le haut-parleur plein (Silenciar).
...
- [ ] Sous 768 px, la home affiche le Short de la semaine en plein écran, son coupé, sans action de l'utilisateur (ou la miniature + la pastille « Toque para ativar o som » si l'autoplay est bloqué).
