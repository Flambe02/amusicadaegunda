-- 🔧 Script de nettoyage complet et configuration pour Música da Segunda
-- Exécutez ce script dans l'éditeur SQL de Supabase
-- Ce script supprime TOUT et recrée proprement la structure
...
-- Supprimer les tables (cela supprimera aussi les index et triggers)
...
-- ===== 4. CRÉATION DE LA FONCTION ET DES TRIGGERS =====
...
-- ===== 6. CONFIGURER RLS ET POLITIQUES =====
-- Activer RLS
