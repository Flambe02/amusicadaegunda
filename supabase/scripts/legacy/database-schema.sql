-- 🎵 Schéma de base de données pour Música da Segunda
...
-- Politique publique pour la lecture des chansons publiées
CREATE POLICY "Chansons publiques visibles par tous" ON songs
  FOR SELECT USING (status = 'published');

-- Politique pour la gestion complète (à ajuster selon vos besoins)
CREATE POLICY "Gestion complète des chansons" ON songs
  FOR ALL USING (true);

-- Politique pour les albums
